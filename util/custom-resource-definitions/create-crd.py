...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--object-meta", help="ObjectMeta Json file", default="object-meta.json"
    )
    ...
    parser.add_argument(
        "--container", help="Container Json file", default="container.json"
    )
    ...
    container = json.load(open(args.container))
    hpa_spec = json.load(open(args.hpa_spec))
    crd["spec"]["validation"]["openAPIV3Schema"]["properties"]["spec"]["properties"][
        "predictors"
    ]["items"]["properties"]["componentSpecs"]["items"]["properties"][
        "metadata"
    ] = object_meta
    crd["spec"]["validation"]["openAPIV3Schema"]["properties"]["spec"]["properties"][
        "predictors"
    ]["items"]["properties"]["componentSpecs"]["items"]["properties"]["spec"] = pod_spec
    crd["spec"]["validation"]["openAPIV3Schema"]["properties"]["spec"]["properties"][
        "predictors"
    ]["items"]["properties"]["componentSpecs"]["items"]["properties"]["hpaSpec"][
        "properties"
    ][
        "metrics"
    ][
    ...
    crd["spec"]["validation"]["openAPIV3Schema"]["properties"]["spec"]["properties"][
        "predictors"
    ]["items"]["properties"]["explainer"]["properties"]["containerSpec"] = container
