    ...
    if "properties" in defn:
        ...
        for prop in defn["properties"].keys():
            if "$ref" in defn["properties"][prop]:
                ...
                "items" in defn["properties"][prop]
                and "$ref" in defn["properties"][prop]["items"]
            ):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--swagger", help="Swagger OpenAPI file", default="swagger.json"
    )
    parser.add_argument(
        "--root", help="root defn", default="io.k8s.api.core.v1.PodSpec"
    )
