...
@click.option(
    "--csv-url",
    default="https://raw.githubusercontent.com/axsauze/reddit-classification-exploration/master/data/reddit_train.csv",
)
...
def run_pipeline(
    labels_path, features_path, csv_url, csv_encoding, features_column, labels_column
):
