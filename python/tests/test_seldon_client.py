from seldon_core.seldon_client import SeldonClient, SeldonClientPrediction, SeldonClientCombine
...
def mock_get_token(oauth_key: str = "",
                   oauth_secret: str = "",
                   namespace: str = None,
...
@mock.patch('seldon_core.seldon_client.prediction_pb2_grpc.SeldonStub',
            new=MyStub)
...
@mock.patch('seldon_core.seldon_client.prediction_pb2_grpc.ModelStub',
            new=MyStub)
...
@mock.patch('seldon_core.seldon_client.prediction_pb2_grpc.GenericStub',
            new=MyStub)
...
@mock.patch('seldon_core.seldon_client.microservice_api_rest_seldon_message',
...
@mock.patch('seldon_core.seldon_client.microservice_api_rest_aggregate',
...
@mock.patch('seldon_core.seldon_client.microservice_api_rest_feedback',
            return_value=SeldonClientCombine(None, None))
...
@mock.patch('seldon_core.seldon_client.microservice_api_grpc_seldon_message',
            return_value=SeldonClientPrediction(None, None))
...
@mock.patch('seldon_core.seldon_client.microservice_api_grpc_aggregate',
            return_value=SeldonClientCombine(None, None))
...
@mock.patch('seldon_core.seldon_client.microservice_api_grpc_feedback',
            return_value=SeldonClientCombine(None, None))
...
@mock.patch('seldon_core.seldon_client.rest_predict_gateway',
            return_value=SeldonClientPrediction(None, None))
...
@mock.patch('seldon_core.seldon_client.grpc_predict_gateway',
            return_value=SeldonClientPrediction(None, None))
...
@mock.patch('seldon_core.seldon_client.rest_predict_seldon_oauth',
            return_value=SeldonClientPrediction(None, None))
...
@mock.patch('seldon_core.seldon_client.grpc_predict_seldon_oauth',
            return_value=SeldonClientPrediction(None, None))
