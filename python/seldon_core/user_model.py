...
class SeldonComponent(object):
    ...
    def send_feedback_raw(self, feedback: prediction_pb2.Feedback
                          ) -> prediction_pb2.SeldonMessage:
    ...
    def transform_input_raw(self, msg: prediction_pb2.SeldonMessage
                            ) -> prediction_pb2.SeldonMessage:
        raise SeldonNotImplementedError(
            "transform_input_raw is not implemented")
    ...
    def transform_output_raw(self, msg: prediction_pb2.SeldonMessage
        ...
        raise SeldonNotImplementedError(
            "transform_output_raw is not implemented")
    ...
    def send_feedback(self, features: Union[np.ndarray, str, bytes],
                      feature_names: Iterable[str], reward: float,
    ...
    def route(self, features: Union[np.ndarray, str, bytes],
    ...
    def aggregate(self, features_list: List[Union[np.ndarray, str, bytes]],
                  feature_names_list: List
                  ) -> Union[np.ndarray, List, str, bytes]:
        raise SeldonNotImplementedError("aggregate is not implemented")

    def aggregate_raw(self, msgs: prediction_pb2.SeldonMessageList
                      ) -> prediction_pb2.SeldonMessage:
...
def client_class_names(user_model: SeldonComponent,
                       predictions: np.ndarray) -> Iterable[str]:
    """
...
def client_predict(user_model: SeldonComponent,
...
def client_transform_input(user_model: SeldonComponent,
                           features: Union[np.ndarray, str, bytes],
                           feature_names: Iterable[str], **kwargs: Dict
                           ) -> Union[np.ndarray, List, str, bytes]:
    """
...
def client_transform_output(user_model: SeldonComponent,
                            features: Union[np.ndarray, str, bytes],
                            feature_names: Iterable[str], **kwargs: Dict
                            ) -> Union[np.ndarray, List, str, bytes]:
    """
...
def client_feature_names(user_model: SeldonComponent,
                         original: Iterable[str]) -> Iterable[str]:
    """
...
def client_send_feedback(user_model: SeldonComponent, features: Union[np.ndarray, str, bytes],
    ...
    if hasattr(user_model, "send_feedback"):
        try:
            return user_model.send_feedback(features,
                                            feature_names,
                                            reward,
                                            truth,
                                            routing=routing)
...
def client_route(user_model: SeldonComponent,
                 features: Union[np.ndarray, str, bytes],
                 feature_names: Iterable[str]) -> int:
    """
...
def client_aggregate(user_model: SeldonComponent,
